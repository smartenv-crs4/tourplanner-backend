...
async function get_data()  {
    ...
    var options = {
    uri: 'http://seidue.crs4.it:3020/api/v1/monuments',
    headers: {
...
function p_insert_db(docs)
{
    ...
    let sql  = format("insert into dat_monument (fk_category, fk_city, _id, DATA, rating, time_to_visit) values (2, 1, %L, %L, %s, %s) ",
    ...
    var sql  = format("select count(*) num  from dat_monument where data->>'title' = %L",  _title)
