...
async function get_data()  {
    ...
    var options = {
    uri: 'http://seidue.crs4.it:3020/api/v1/archeosites',
    headers: {
...
function p_insert_db(docs)
{
    ...
    let sql  = format("insert into dat_archeo_site (fk_category, fk_city, _id, DATA, rating, time_to_visit) values (1, 1, %L, %L, %s, %s) ",
    ...
    var sql  = format("select count(*) num  from dat_archeo_site where data->>'title' = %L",  _title)
