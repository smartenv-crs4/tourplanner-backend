...
async function get_data()  {
    ...
    var options = {
    uri: 'http://seidue.crs4.it:3020/api/v1/gardens',
    headers: {
...
function p_insert_db(docs)
{
    ...
    let sql  = format("insert into dat_garden (fk_category, fk_city, _id, DATA, rating, time_to_visit) values (4, 1, %L, %L, %s, %s) ",
    ...
    var sql  = format("select count(*) num  from dat_garden where data->>'title' = %L",  _title)
